...
[^2]: This is mainly becuase partial derivatives of the Jacobian matrix are non-zero when it comes to non-linear parameter transformations, which is related to  Christoffel symbols or Levi-Civita connection coefficients.
