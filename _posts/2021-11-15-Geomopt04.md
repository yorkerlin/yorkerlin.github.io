...
[^2]: This is mainly becuase partial derivatives of the Jacobian matrix (Eq. \eqref{7}) are non-zero when it comes to non-linear parameter transformations. These partial derivatives are also related to  Christoffel symbols or Levi-Civita connection coefficients.
