...
By using the Taylor approximation, we

* use the distance defined in a (Riemannian) gradient space to approximate the distance in a parameter space.

* implicitly assume that the parameter space is **open** due to the definition of the
    approximation.
</div>
