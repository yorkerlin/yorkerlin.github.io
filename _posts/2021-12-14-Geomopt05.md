...
* An invertiable linear reparametrization could also be a natural parametrization. This is one of reasons that natural-gradient descent is better than (Euclidean) gradient descent since natural-gradient descent is linearly invariant.
    <div class="notice--info" markdown="1">
    <details>
