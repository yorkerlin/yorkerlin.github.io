...
The orthogonality and distance between two <span style="color:red">vectors at one point</span> are also induced by the Fisher matrix since we can define them by using the norm.
