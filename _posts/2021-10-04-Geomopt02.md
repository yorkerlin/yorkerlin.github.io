...
Moreover, a natural gradient (in a gradient space) is invariant as shown in 
<!--Part III -->
[Part III]({{ site.baseurl }}{% post_url 2021-11-02-Geomopt03 %}#riemannian-steepest-direction-is-invariant) while a natural-gradient update (in a parameter space) is only linearly invariant as discussed in
<!--Part IV.-->
[Part IV]({{ site.baseurl }}{% post_url 2021-11-15-Geomopt04 %}#natural-gradient-descent-in-an-intrinsic-parameter-space).
