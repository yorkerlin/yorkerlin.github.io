...
we can show the Fisher-Rao metric is a Riemannian metric for this new intrinsic parameterization due to the chain rule.
...
Note that the Fisher matrix is often not well-defined under a **non-intrinsic** parameterization.
