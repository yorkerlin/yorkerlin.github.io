...
If this smoothness requirement is satisfied, we can show the Fisher-Rao metric is a Riemannian metric for any **intrinsic** parameterization due to the chain rule.
