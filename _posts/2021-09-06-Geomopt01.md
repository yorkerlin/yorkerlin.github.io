...
In these blog posts, we assume that the metric is well-defined.
...
Note that the Fisher matrix is often not well-defined under an **extrinsic** parameterization.
