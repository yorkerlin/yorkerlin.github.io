...
A regularity condition to find an intrinsic parametrization $\tau $ is that the set of partial derivatives 
...
If this smoothness requirement is statistified, we can show the Fisher-Rao metric is a Riemannian metric for any **intrinsic** parameterization due to the chain rule.
