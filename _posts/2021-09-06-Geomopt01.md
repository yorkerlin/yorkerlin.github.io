...
The following parametrization of the circle is **not** an intrinsic parameterization.
$\\{ f(\theta) \| \theta \in [0,2\pi)  \\} $

This map $f$ is bijective and smooth. However, its inverse map $f^{-1}$ is **not** continous at point $(0,1) \in  \mathcal{S}^1$.
This smoothness requirement of the inverse map is essential when it comes to reparametrization (A.K.A. parameter transformation) for stastical manifolds. The requirement gives us a way to generate new intrinsic parameterizations.
