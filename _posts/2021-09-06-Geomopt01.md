...
Clearly, a point $ (0,1) $ highlighted in green is in the circle, where we consider its center as the orgin.
...
we show that the circle does **not** look like a flat space under the following parametrization
...
Technically, the following parametrization of the circle is not smooth enough.
...
Technically, we have to enforce this additional assumption when it comes to reparametrization (A.K.A. parameter transformation) for stastical manifolds. 
