...
Technically, we have to enforce an additional smooth assumption of the inverse map when it comes to reparametrization (A.K.A. parameter transformation) for stastical manifolds. 
