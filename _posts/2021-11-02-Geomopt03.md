...
We will discuss  transformation rules related to natural-gradients and how to compute natural-gradients in a new coordinate system via Automatic Differentiation.

However, the Euclidean counterpart in general can be non-invariant, which is the key reason to explain why Euclidean gradient descent is not invariant.
